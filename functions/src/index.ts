...
app.get('/', (request:any,response:any) => {
	response.send("<h1>Welcome to Connect from ts</h1>");
});

app.get('/welcome', (request:any, response:any) => {
	response.send("<h1>This is Welcome from ts</h1>");
});

app.get('/normal/:lat/:lng', (request:any, response:any) => {
